  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Cuisine - Transforming your kitchen experience with our premier recipe SaaS service. Discover, create, and share culinary masterpieces."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjdWlzaW5lfGVufDB8fHx8MTY5ODczODMxNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Cuisine - Transforming your kitchen experience with our premier recipe SaaS service. Discover, create, and share culinary masterpieces.`}
            </Text>
            <Box
