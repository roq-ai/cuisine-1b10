...
import { useRoqClient, useFavoriteFindManyWithCount } from 'lib/roq';
...
export function FavoriteListPage(props: FavoriteListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useFavoriteFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.favorite.delete({ where: { id } });
      await mutate();
    } catch (error) {
