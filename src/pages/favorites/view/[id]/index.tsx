...
import { useFavoriteFindFirst, useRoqClient } from 'lib/roq';
...
function FavoriteViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; recipe: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useFavoriteFindFirst(queryParams, {}, { disabled: !id });
